...
* **Nội dung công việc cần nắm vững:** 
  ...
  * Biết cách đọc/truy vấn dữ liệu với SQL để kiểm tra CSDL.

#### 2. M – Measurable (Đo lường được)
Mục tiêu được định lượng bằng các kết quả đầu ra cụ thể:
* **Học tập:** Hoàn thành 1 khóa học QA/Testing (đạt chứng nhận hoàn thành khóa học).
* **Sản phẩm (Portfolio):** 
  * 01 Repository trên GitHub chứa bộ tài liệu kiểm thử (Test Plan, Test Cases, Bug Log) cho một ứng dụng E-commerce thực tế.
  * 01 Collection bài kiểm thử API tự động bằng Postman/Newman.
* **Ứng tuyển:** Nộp CV đến 15 công ty, đạt tối thiểu 3 buổi phỏng vấn và nhận được ít nhất 1 Offer thư mời làm việc.

#### 3. A – Achievable (Tính khả thi)
* **Nền tảng sẵn có:** Đã có kiến thức cơ bản về tư duy logic, CSDL và kiểm thử phần mềm trong chương trình học.
* **Thời gian đầu tư:** Cam kết dành **12 – 15 giờ/tuần** (2 giờ/ngày thường + 4 giờ ngày cuối tuần) liên tục trong 6 tháng để học và làm dự án thực tế.

#### 4. R – Relevant (Tính thực tế & Phù hợp)
* Phù hợp với định hướng nghề nghiệp dài hạn trong ngành Công nghệ Thông tin.
* Đáp ứng đúng nhu cầu tuyển dụng vị trí Tester/QA đầu vào của các doanh nghiệp hiện nay.
